            ...
            <TableRow sx={{ backgroundColor: "#34ac92" }}>
              {props.columns?.map((column) => (
                <TableCell
                  key={column.id}
                  align={column.align}
                  sx={{ fontWeight: "600", minWidth: column.minWidth, backgroundColor: "#34ac92", color: "white" }}
                >
                  {column.label}
                </TableCell>
              ))}
                      ...
                      if (column.id === 'action') {
                        return (
                          <TableCell key={column.id}>
                            {props.onPrint && (
                              <Button sx={{ minWidth: "auto" }} onClick={(e) => handlePrint(row)}>
                                <PrintIcon />
                              </Button>
                            )}
                            {props.onView && (
                              <Tooltip title="Chỉnh sửa">
                                <Button sx={{ minWidth: "auto" }} onClick={(e) => handleView(row)}>
                                  <EditIcon
                                    color="secondary"
                                  />
                                </Button>
                            ...
                            {props.onDetails && (
                              <Tooltip title="Chi tiết">
                                 <Button sx={{ minWidth: "auto" }} onClick={(e) => handleDetails(row)}>
                                  <VisibilityIcon
                                    color="secondary"
                                  />
                                </Button>
